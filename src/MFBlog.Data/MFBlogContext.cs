using MFBlog.Core.Domain.Content;
...
{
    public class MFBlogContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        public MFBlogContext(DbContextOptions options) : base(options)
        {
        }
